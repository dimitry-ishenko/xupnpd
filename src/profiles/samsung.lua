...
profiles['Samsung-AllShare']=
{
    ...
    ['match']=function(user_agent) if string.find(user_agent, '^OPPO PLAYER') == nil and
        (string.find(user_agent,'DLNADOC/1.50',1,true) or string.find(user_agent,'SEC_HHP_',1,true)) then
